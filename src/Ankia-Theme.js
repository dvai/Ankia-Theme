...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.onscroll = function () {
        ...
        } else if (currentScrollPos - prevScrollPos > scrollDistance && !document.querySelector("#menu.showMenu")) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (tocPane) {
        bloggerInfoCard.style.display = "none";
    } else {
        bloggerInfoCard.style.display = "block";
    }
}, false);
